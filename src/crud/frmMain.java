...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(wedok))
                            .addComponent(tinggi, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIS", "Nama Siswa", "Jenis Kelamin", "Tinggi Badan", "Kelas", "Email", "Alamat"
            }
        ));
        ...
        jLabel8.setText("Form Pendaftaran Kartu Telkom Sakit");
    ...
    JOptionPane.showMessageDialog(this, "Harap Lengkapi Data", "Error", JOptionPane.WARNING_MESSAGE);
        ...
        String SQL = "INSERT INTO t_siswa (NIS,NamaSiswa,JenisKelamin,TinggiBadan,Kelas,Email,Alamat)"
                + "VALUES('"+nis.getText()+"','"+nama.getText()+"','"+JK+"','"+tinggi.getText()+"',"
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {                                          
      ...
      nama.setText(tblData.getValueAt(tblData.getSelectedRow(),1).toString());
       ...
       kelas.setText(tblData.getValueAt(tblData.getSelectedRow(),4).toString());
       email.setText(tblData.getValueAt(tblData.getSelectedRow(),5).toString());
       alamat.setText(tblData.getValueAt(tblData.getSelectedRow(),6).toString());
...
// TODO add your handling code here:
    ...
    public void selectData() {
       ...
       String kolom[] = {"NIS","NamaSiswa","JenisKelamin","TinggiBadan","Kelas","Email","Alamat"};
       ...
       try{
           while(rs.next()){
               ...
               String Tinggi = rs.getString(4);
               String Kelas = rs.getString(5);
               String Email = rs.getString(6);
               String Alamat = rs.getString(7);
               String data[] = {NIS,NamaSiswa,JenisKelamin,Tinggi,Kelas,Email,Alamat};
               dtm.addRow(data);
           }
